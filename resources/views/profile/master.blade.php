                ...
                <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                          ...
                          <li class="dropdown">
                            <a href="{{url('/messages')}}" 
                               role="button" aria-expanded="false">
                                <img src="/img/msg_icon.png" width="30"/>
                                <span class="badge"
                          ...
                          <ul >
                            ...
                            <li>
                               ...
                               <li class="dropdown">
                                <a href="/notifcations" class="dropdown-toggle" data-toggle="dropdown"
                                   role="button" aria-expanded="false">
                    ...
                    <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                    <img src="/img/{{Auth::user()->pic}}" width="30px" height="30px" class="img-circle"/>
